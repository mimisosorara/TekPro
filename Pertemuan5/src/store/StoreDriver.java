...
public class StoreDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (sc.hasNext()) {
            ...
            if (employeeType.equals("Manager")) {
             ...
             //    Then add the salesAssociate object to the arrayList of salesAssociateList
                ...
                double salesRate = sc.nextDouble();
                Cashier cashier = new Cashier(salesRate, numberOfHoursWorked, hourlyRate, storeDetails, empName, basePay);
        ...
        for (SalesAssociate salesAssociate : SalesAssociateList) {
            ...
            System.out.println("ID: " + salesAssociate.getEmployeeID());
            System.out.println("Tax: " + salesAssociate.getTax());
        ...
        for (Cashier cashier : CashierList) {
            ...
            System.out.println("ID: " + cashier.getEmployeeID());
            System.out.println("Tax: " + cashier.getTax());
            pwd.println(cashier);
